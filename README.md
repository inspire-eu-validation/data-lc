...
5. The IR conformance classes for application schemas without non-abstract feature types, e.g. "Land Cover - Core", are not needed as no feature instance can be of a type from that application schema.
