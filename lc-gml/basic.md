...
**Purpose**: Verify that the spatial data set contains at least one Land Cover feature.
...
* [TG DS-LC](./README.md#ref_TG_DS_LC) 5.4, 5.5
...
----------------------------------------------------- | ------------------------------------------------------------------
features <a name="features"></a>   |  //schema-element(lcv:LandCoverDataset) <br> OR <br>  //schema-element(lcr:LandCoverGridCoverage)